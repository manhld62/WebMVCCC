...
namespace RaZorWebxxx.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (remoteError != null)
            {
                ErrorMessage = $"Lỗi tự dịch vụ ngoài: {remoteError}";
                return RedirectToPage("./Login", new {ReturnUrl = returnUrl });
            }
            var info = await _signInManager.GetExternalLoginInfoAsync();
            if (info == null)
            {
                ErrorMessage = "Không Lấy được dịch vụ.";
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if ((registeduser != null) && (externalEmailuser != null))
                {
                    ...
                    {
                        ModelState.AddModelError(string.Empty, "Không Liên kết Được tài khoản,sử dụng email khác");
                ...
                if ((externalEmailuser == null) && (externalEmail == Input.Email))
                {
                    ...
                    {
                        ModelState.AddModelError(string.Empty,  "Không tạo được tài khoản mớis");
                        return Page();
