...
namespace RaZorWebxxx.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //[EmailAddress]
            [Display(Name = "Địa Chỉ Email hoặc têm tài khoản")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Tài Khoản Không Đúng");
                    return Page();
                }
            }
